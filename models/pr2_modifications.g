...
Edit r_shoulder_lift_joint { q=1   gains=[200 20] armR }
#Edit r_upper_arm_roll_joint { q=1   gains=[100 8] armR }
Edit r_elbow_flex_joint {  q=-1.0  gains=[70 4] armR }
...
Edit l_shoulder_lift_joint {  q=1   gains=[200 20] armL }
#Edit l_upper_arm_roll_joint { q=1  gains=[100 8] armL }
Edit l_elbow_flex_joint {     q=-1  gains=[70 4] armL }
