...
Edit finger1{ joint:transX Q:<> A:<t(+.11 0 -.05)> limits: [-.05 0.02], contact: -2, shape:capsule, size:[.02, .02] }
Edit finger2{ joint:transX mimic:(finger1) Q:<> A:<d(180 0 0 1) t(+.11 0 -.05)>, contact: -2, shape:capsule, size:[.02, .02]}
