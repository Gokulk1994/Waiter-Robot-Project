...
if __name__ == '__main__':
    ...
    if user_ip:
        ...
        #target = env.get_position("dyna_coffe_mug") + [0, -0.08, 0]
        target = np.array([2.35, 2.1, 0.783])
    ...
    #percept_red_table_pos = [-0.18, 0.6, 0]
